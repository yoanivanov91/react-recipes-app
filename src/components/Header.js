          ...
          <div className="collapse navbar-collapse flex-grow-0" id="navbarContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <NavLink className={styles.navLink + " nav-link"} to="/" end>
                  Home
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className={styles.navLink + " nav-link"} to="/recipes" end>
                  Recipes
                </NavLink>
              </li>
              {!user && (
                <>
                  <li className="nav-item">
                    <NavLink className={styles.navLink + " nav-link"} to="/auth/login" end>
                      Login
                    </NavLink>
                  </li>
                  <li className="nav-item">
                    <NavLink className={styles.navLink + " nav-link"} to="/auth/register" end>
                      Register
                    </NavLink>
                  </li>
                </>
              ...
              {user && (
                <>
                  <li className="nav-item">
                    <NavLink className={styles.navLink + " nav-link"} to="/recipes/add" end>
                      Add recipe
                    </NavLink>
                  </li>
                  <li className="nav-item dropdown">
                    <button
                      className={styles.navLink + " nav-link dropdown-toggle button-style-reset"}
                    ...
                    <ul className="dropdown-menu dropdown-menu-end">
                      ...
                      <li>
                        <button className="dropdown-item" onClick={() => handleLogout(user)}>
                          Logout
                        </button>
                      </li>
                    </ul>
